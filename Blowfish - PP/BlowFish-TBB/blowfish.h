...
protected:
	...
	void encipher(unsigned* xr_var,unsigned* xl_var);
	void decipher(unsigned* xr_var,unsigned* xl_var);

	void encipher();
	void decipher();
	unsigned int round(unsigned int a, unsigned int b, unsigned int n);
	void setblock(byte* block, int offset,unsigned* xr_var,unsigned* xl_var);
	void getblock(byte* block, int offset,unsigned* xr_var,unsigned* xl_var);
